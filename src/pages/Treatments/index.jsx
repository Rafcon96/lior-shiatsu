...
היכולה לסייע בבעיות אורתופדיות בעמוד השדרה, בעיות פנימיות בתחומי נוירולוגיה, בעיות עיכול, גינקולוגיה, בעיות רגשיות כמו הפרעות שינה, מתח, דיכאון ועוד.
    ...
    ,{title: [`דיקור`,`Acupuncture`],
     body1:[`למה אנחנו דוקרים,  ואיך זה עובד ? 
     ...
     ולשחרור אנדורפינים ויוצרת זרימת דם טובה יותר באזור הנדקר. מה שמפחית את מדדי הדלקת 
         ואת הפעילות החשמלית הספונטנית.`,`english1`],
    body2:[` מבדיקה וסקירה עדכנית, נמצא כי הדיקור הראה השפעה ברמה בינונית עד גבוהה 
    ...
    https://www.bmj.com/content/376/bmj-2021-067475`,`english2`],
    body3:[`    האם זה כואב ?
...
לפי התיאוריה הסינית, הצ'י היא אנרגיית החיים. 
    ...
    באמצעות הדיקור, מתקנים יכולים לשפר את זרימת האנרגיה בגוף ולשפר את האיזון בין היאנג לין `, `english 2`]

     ,img:"/car3.jpg"}
     ,{title: ["כוסות רוח","Cupping therapy"],
        img:"/car2.jpg",
        imgLeft:true,
        body1:[`כוסות רוח הן שיטת טיפול אלטרנטיבית, שהייתה נפוצה באירופה ובחלקים נוספים בעולם וביבשות נוספות, ונחשבת/ מוכרת כחלק אינטגרטיבי בטיפול לפי הרפואה הסינית. 
        ...
        מנגנון הפעולה לא באמת מובן עד הסוף,`,`eng1`],
        body2:[`         איך זה עובד ? 
        ...
        ההבנה שבשל הוואקום העור נמשך פנימה אל הכוס, והלחץ השלילי גורם לזרימת דם מוגברת לאזור, או שמשיכת השריר העדינה למס' הדקות עוזרת לשחרורו, ישנם שבירות קלות של קפילרות, נימי הדם מה שיוצר את הסימנים המאפיינים, בעקבות זאת יש זרימה טובה יותר של חמצן ואנריגיה "QI" למקום הפגוע והתקוע מה שמסב לרוב הקלה מידית בכאב.  `,`eng2`] 

       ,body3:[` מתי כל זה התחיל ? 
       ...
       השיטה הומלצה ע"י הנביא מוחמד, יש הזכורים גם בספרו של הרמב"ם ולכן הייתה מאד שימושית בתוך הקהילה היהודית במזרח אירופה, במצריים העתיקה ומקומות נוספים בעולם, 
        בתחלת ה-120 , סר ולים אוסלר שכונה "אבי הרפואה המודרנית" בזכות תרומתו הרבה לרפואה באר"הב ובעולם  מהמליץ על שימוש בכוסות רוח לדלקות ריאה ולדלקת מיאליטיס(דלקת בעמוד השידרה). `,`eng3`
        ]
    }
    ]
    ...
    <Grid container spacing={1}>
        ...
        <Grid item container justifyContent={"center"}>
            ...
            <Grid item container xs={12} md={6} justifyContent={"center"}>
                 ...
                 <img src={process.env.PUBLIC_URL + res[0].img} alt={res[0].title[Number(language)]}
            ...
            <Grid item container xs={12} md={6} justifyContent={"center"}>
                 ...
                 <img src={process.env.PUBLIC_URL + res[1].img} alt={res[1].title[Number(language)]}
                     style={{maxHeight:"90%",maxWidth:"100%"}} />
            ...
            <Grid item container xs={12} md={6} justifyContent={"center"}>
                 ...
                 <img src={process.env.PUBLIC_URL + res[2].img} alt={res[2].title[Number(language)]}
                     style={{maxHeight:"90%",maxWidth:"100%"}} />
