...
const res = {
    ...
    האבחנה מתבצעת בתשאול, לפי העקרונות הסינים והמערביים, של אורח והרגלי חיים כמו, 
    כמה מים אתה שותה? מה טיב השינה ? וכו'...
    ננסה לגלות יחד האם יש סיבה רגשית או התנהגותית שעומדת מאחורי הכאב. 
    `,
...
const content = [ 
     {title: ["למי מיועד הטיפול","Who is the treatment for"],
        img:"/lior1.png",
        imgLeft:true,
        body:[`.הטיפול מתאים לאנשים המתמודדים עם בעיות בריאותיות או רגשיות כטיפול טבעי משלים
        .למי שחווה כאב פיזי וכן למי שמתמודד עם קושי נפשי, באופן כרוני או תקופתי 
